function [x,w]=jacobi_rule_xw ( order, alpha, beta, a, b)
...
%
  kind = 4;  % Gauss-Jacobi Quadrature, i.e., domain of integration is(a,b), weight function is(b-x)^alpha*(x-a)^beta
  %order=2;alpha=0;beta=-0.5;a=0;b=1;
